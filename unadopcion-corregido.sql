...
(
   ADOP_ID              bigint not null AUTO_INCREMENT,
...
create table ANIMAL
(
   ANIM_ID              bigint not null AUTO_INCREMENT,
   ADOP_ID              bigint,
   REGIS_ID             bigint not null,
   ANIM_NOMBRE          char(100) not null,
   ANIM_TIPO            char(100) not null,
   ANIM_LUGAR           char(255) not null,
   ANIM_DESCRIP         char(255) not null,
...
(
   ANIM_VAC_ID          bigint not null AUTO_INCREMENT,
   ANIM_ID              bigint not null,
...
(
   DENUN_ID             bigint not null AUTO_INCREMENT,
   USUARIO_ID           bigint not null,
   DENUN_FECHA          date not null,
   DENUN_TIPO           char(32),
   DENUN_DESCRIP        char(255) not null,
...
create table LOGEO
(
   LOGEO_ID             bigint not null AUTO_INCREMENT,
   USUARIO_ID           bigint,
   LOGEO_NOMBRE         char(100) not null,
   LOGEO_CONTRA         char(255) not null,
...
(
   REGIS_ID             bigint not null AUTO_INCREMENT,
   ANIM_ID              bigint,
...
(
   SOLICI_ID            bigint not null AUTO_INCREMENT,
   ANIM_ID              bigint not null,
...
(
   ...
   USUARIO_LUGAR        char(255),
   USUARIO_INFO         char(255),
